...
#Initiliaze pygram module for playing audio
pygame.init()

#load the game music
pygame.mixer.music.load(r"C:\Users\ahmad\Desktop\350\Game sound 12 mins.mp3")
...
num_players = int(input("Please enter the number of players that will join this game: "))
...
for round_num in range(1,4):
   ...
   #In case the player enters a wrong input he will get a score
    for score in round_scores:
        if score[1] == None: score[1] = ceil(worst_score_this_round)
    ...
    cumulative_table = colored(cumulative_table, "red")
    ...
    inbet+= "________________________________________________\n"
    inbet = colored(inbet, "cyan", attrs=["bold"])
...
# Load the image
img = QImage(r"C:\Users\ahmad\Desktop\350 (1)\350\Our Picture.jpg")

# Create a label and set the image as the pixmap
label = QLabel()
pixmap = QPixmap.fromImage(img)
label.setPixmap(pixmap)

# Show the label inside Spyder
label.show()
